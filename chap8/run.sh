...
export LD_LIBRARY_PATH=${CUDA_ROOT}/lib64:${LD_LIBRARY_PATH}:/home/getalp/garnerim/miniconda3/envs/my_espnet/espnet/espnet_v.0.3.1/tools/venv/lib
...
train_set=train_960_wper_50_seed42_3816
train_dev=dev
...
#resume=${expdir}/results/snapshot.ep.9
#add --resume ${resume} \ below
